...
import 'package:wallet_dart/contracts/factories/GnosisSafe.g.dart' as g;
...
import 'package:wallet_dart/contracts/factories/GnosisSafeAccountFactory.g.dart';
...
class CWallet {
  ...
  static g.GnosisSafe safeInterface(EthereumAddress address, {Web3Client? client}) => g.GnosisSafe(address: address, client: client ?? Constants.web3client);
  ...
  static GnosisSafeAccountFactory gnosisSafeAccount(EthereumAddress address, {Web3Client? client}) => GnosisSafeAccountFactory(address: address, client: client ?? Constants.web3client);
}